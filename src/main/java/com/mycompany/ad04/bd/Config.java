...
public class Config {
    ...
    public int    getPort(){         return dbConnection.port; }
    ...
    public String getDriver(){       return hibernate.driver; }
    public String getDialect(){      return hibernate.dialect; }
    public String getHBM2DDL_AUTO(){ return hibernate.HBM2DDL_AUTO; }
    public String getSHOW_SQL(){     return hibernate.SHOW_SQL; }    
}
